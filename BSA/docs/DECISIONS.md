...
- Question: does the G repair clear those findings? Choice: the same isolated assertions pass on `c3f69f2`; retain the earlier failure and separately record this bounded source pass. Do not upgrade it to UI, full-suite or live acceptance. Tie-breaker: immutable, source-pinned evidence and the live-first boundary.
