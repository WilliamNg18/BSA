...
- Manual and generated outbound notes are checked at the final action.
  Unsafe text produces an explicit error, never a silent rewrite; original
  read-only evidence facts are preserved.
