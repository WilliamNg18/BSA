...
export const PUBLIC_FACTS = Object.freeze({ annualItems: 1_100_000_000, monthlyReferrals: 85_000, annualReferrals: 1_000_000, accuracyTarget: 99.85 });
...
export const TOUR_CONTENT = {
  chapters: [
    { chapter: 1, title: "The referred-back subset", prose: "Approximately 85,000 items return monthly for clarification. This subset is not the whole operator queue; accuracy figures are targets, not measured achievement." },
    { chapter: 3, title: "Test the manual baseline", prose: "Compare manual evidence gathering with a pre-fetched screen and deterministic checks. Validate operator effort before attributing benefits to interpretation." },
  ...
  keyFigures: [
    ...
    { id: "accuracy-target", value: "99.85%", label: "Stated PPIA and PPPA target", qualifier: "Target, not achieved performance or an allowed count of wrong payments." },
  ],
