...
export const CASES: ExceptionCase[] = [
  {
    ...
    purpose: "Show that the system does not create unnecessary work: the endorsement satisfies the rule, the case is pre-cleared and the operator confirms in one look.",
    pharmacy: { name: "Riverside Chemist", contractorCode: "FH774" },
    routingReason: "NCSO endorsement present: concession claim requires operator check",
    channel: "Paper FP10",
    ...
    inCoverage: true,
    initialState: "agent_review_complete",
  },
  {
    id: "EX-24112",
    scenario: "B",
