...
import { initialisePharmacyDraft, checkPharmacyCorrection } from "@/lib/domain/pharmacy-correction";
...
export function usePharmacyDraft(caseId: string, channel?: ItemChannel) {
  ...
  return { c, revision, draft, original, enabled, result, validationError, error, act, update };
}
