/** Original lifecycle fixtures retained for historical regression evidence only. */
import { HISTORICAL_CASES as CASES } from "./historical-cases";
import { TWO_GATE_CASES } from "../../src/lib/domain/cases";
import { HILLCREST_PHARMACY, productByCode } from "../../src/lib/domain/reference";
import type { CaseLifecycle, CaseRevision, HistoryEvent, LifecycleState } from "../../src/lib/domain/lifecycle";
