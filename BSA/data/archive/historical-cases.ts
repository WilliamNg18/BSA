/** Original synthetic case evidence retained verbatim, not current scenario headlines. */
import type { ExceptionCase } from "../../src/lib/domain/types";
import { HILLCREST_PHARMACY } from "../../src/lib/domain/reference";
import { readNcso } from "../../src/lib/domain/synthetic-readings";

export const HISTORICAL_CASES: ExceptionCase[] = [
  {
    id: "EX-24107",
    scenario: "A",
